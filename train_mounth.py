...
model_checkpoint = ModelCheckpoint(filepath='mouth_only_model.keras',  #  Change .h5 → .keras
...
Drowsiness_detection.save("drowsiness_mouth_cnn_model.h5")
